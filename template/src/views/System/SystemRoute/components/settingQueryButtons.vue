<template>
  <div class="setting-query-buttons">
    <div
      class="operation"
...
import { BUTTONS_SETTING } from './settingInfo'
export default {
  name: 'settingQueryButtons',
  components: {
    flmForm,
    flmDrawer
  },
  ...
  methods: {
    handleShowDetail(index) {
      let config = this.buttonsData[index].config
      console.log(index)
      console.log(config)
